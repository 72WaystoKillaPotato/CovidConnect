...
//  CovidConnet
//
//  Created by Samantha Su on 4/4/20.
...
class AppDelegate: UIResponder, UIApplicationDelegate, UIWindowSceneDelegate {
    ...
    let notificationDelegate = NotificationWhenOpenDelegate()
    ...
    // MARK: - Firebase Cloud Messaging functions
...
extension Date {
    func interval(fromDate date: Date) -> Int {
